...
var config = {
  ...
  "interface": {
    "update": function () {
      ...
      chrome.storage.local.get(null, function (e) {
        ...
        config.elements.enable_log.checked = e.enable_log === true;
        config.elements.site_scope.value = e.site_scope === "url" ? "url" : "host";
      });
      /*  */
  ...
  "load": function () {
    ...
    config.elements.enable_log = document.getElementById("enable_log");
    config.elements.site_scope = document.getElementById("site_scope");
    ...
    config.elements.enable_log.addEventListener("change", config.handle.store);
    config.elements.site_scope.addEventListener("change", function () {
      chrome.storage.local.set({"site_scope": config.elements.site_scope.value}, function () {});
    });
